...
if _G.httpRequest then
    ...
    Callback = function(p170)
        if p170 then
            ...
            -- Main Frame (RESPONSIVE - Scale based)
            ...
            icon.Size = UDim2.new(0.08, 0, 0.12, 0)
            ...
            title.Text = "🎣 ENHANCED FISHING PANEL"
            title.TextSize = 18
            ...
            divider.BackgroundColor3 = Color3.fromRGB(80, 200, 255)
            ...
            -- Info Section Header
            local infoHeader = Instance.new("TextLabel", mainFrame)
            infoHeader.Size = UDim2.new(0.9, 0, 0.08, 0)
            infoHeader.Position = UDim2.new(0.05, 0, 0.2, 0)
            infoHeader.BackgroundTransparency = 1
            infoHeader.Font = Enum.Font.GothamBold
            infoHeader.Text = "📊 INVENTORY STATUS"
            infoHeader.TextSize = 14
            infoHeader.TextScaled = true
            infoHeader.TextColor3 = Color3.fromRGB(140, 200, 255)
            infoHeader.TextXAlignment = Enum.TextXAlignment.Left

            -- Fish Count Display
            local fishCountLabel = Instance.new("TextLabel", mainFrame)
            fishCountLabel.Size = UDim2.new(0.9, 0, 0.08, 0)
            fishCountLabel.Position = UDim2.new(0.05, 0, 0.3, 0)
            fishCountLabel.BackgroundTransparency = 1
            fishCountLabel.Font = Enum.Font.Gotham
            fishCountLabel.Text = "🐟 Fish: 0/0"
            fishCountLabel.TextSize = 16
            fishCountLabel.TextScaled = true
            fishCountLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            fishCountLabel.TextXAlignment = Enum.TextXAlignment.Left

            -- Total Caught Header
            local caughtHeader = Instance.new("TextLabel", mainFrame)
            caughtHeader.Size = UDim2.new(0.9, 0, 0.08, 0)
            caughtHeader.Position = UDim2.new(0.05, 0, 0.42, 0)
            caughtHeader.BackgroundTransparency = 1
            caughtHeader.Font = Enum.Font.GothamBold
            caughtHeader.Text = "💰 TOTAL STATISTICS"
            caughtHeader.TextSize = 14
            caughtHeader.TextScaled = true
            caughtHeader.TextColor3 = Color3.fromRGB(140, 200, 255)
            caughtHeader.TextXAlignment = Enum.TextXAlignment.Left

            -- Total Caught Display
            local totalCaughtLabel = Instance.new("TextLabel", mainFrame)
            totalCaughtLabel.Size = UDim2.new(0.9, 0, 0.08, 0)
            totalCaughtLabel.Position = UDim2.new(0.05, 0, 0.52, 0)
            totalCaughtLabel.BackgroundTransparency = 1
            totalCaughtLabel.Font = Enum.Font.Gotham
            totalCaughtLabel.Text = "💰 Value: 0"
            totalCaughtLabel.TextSize = 16
            totalCaughtLabel.TextScaled = true
            totalCaughtLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
            totalCaughtLabel.TextXAlignment = Enum.TextXAlignment.Left
            ...
            statusGradient.Transparency = NumberSequence.new(0.8)
            ...
            task.spawn(function()
                while statusLabel and statusLabel.Parent do
                    TweenService:Create(statusLabel, TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true), {
            ...
            -- Update loop with stuck detection
            local lastCaughtValue = vu171.leaderstats.Caught.Value
            ...
            task.spawn(function()
                while vu7.fishingPanelRunning and task.wait(1) do
                    local bagSize = ""
                    pcall(function()
                        bagSize = vu171.PlayerGui.Inventory.Main.Top.Options.Fish.Label.BagSize.Text
                    end)

                    local currentCaught = vu171.leaderstats.Caught.Value
